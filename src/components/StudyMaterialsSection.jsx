...
const COPY = {
  sv: {
    ...
    items: [
      ...
      { to: '/lessons-b2c1', label: 'Rivstart B2/C1', count: '202', desc: 'Ord och verb från kapitel 1–3 m.m. (AnnaRansheim).' },
    ],
  },
  en: {
    tag: 'VERBS & QUIZLET',
    ...
    items: [
      ...
      { to: '/lessons-b2c1', label: 'Rivstart B2/C1', count: '202', desc: 'Words and verbs from chapters 1–3 and more (AnnaRansheim).' },
    ],
  },
  ar: {
    ...
    items: [
      ...
      { to: '/lessons-b2c1', label: 'Rivstart B2/C1', count: '202', desc: 'كلمات وأفعال من الفصول 1–3 وغيرها (AnnaRansheim).' },
    ],
  },
};
